  ...
  message.reply(
    attachment: {
      ...
      payload: {
        ...
        buttons: [
          { type: 'postback', title: 'Yes', payload: 'START_USER_SURVEY' },
...
def create_new_user(messenger_id)
  ...
  url = "https://graph.facebook.com/v4.0/#{messenger_id}?fields=first_name,last_name,gender&access_token=#{ENV["ACCESS_TOKEN"]}"
